    ...
    <div class="navbar-nav-wrap">
      ...
      <div class="navbar-nav-wrap-content-start">
        ...
        if($final==1)
        {
              ...
              <a class="btn btn-danger" href="../management/index.php">End Auction</a>
                 </li>';
        }
        else
        {
      ...
      <div class="navbar-nav-wrap-content-end">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a class="btn btn-outline-success" href="../management/index.php">Home</a>
          </li>
         
          <li class="nav-item d-none d-sm-inline-block">
          <a class="btn btn-outline-success" href="../management/team_management.php">Summary</a>
          </li>
