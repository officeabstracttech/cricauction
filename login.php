    ...
    <div class="container py-5 py-sm-7">
      ...
      <div class="mx-auto" style="max-width: 30rem;">
        ...
        <div class="card card-lg mb-5">
          <div class="card-body">
            <!-- Form -->
            <form class="js-validate needs-validation" method="post" action="login.php"  novalidate>
              <div class="text-center">
                <div class="mb-5">
                  <h1 class="display-5">Login Here</h1>
                </div>
                <span class="divider-center text-muted mb-4">CricAuction</span>
              </div>
              ...
              <div class="mb-4">
                ...
                <div class="input-group input-group-merge" data-hs-validation-validate-class>
                  <input type="password" class="js-toggle-password form-control form-control-lg" name="pwd" id="signupSrPassword" placeholder="8+ characters required" aria-label="8+ characters required" required minlength="8" data-hs-toggle-password-options='{
              ...
              <div class="d-grid">
                <button type="submit" name="sbtn" class="btn btn-primary btn-lg">Log in</button>
              </div>
                        </br>
        ...
        <div class="position-relative text-center zi-1">
          <small class="text-cap text-body mb-4">World's best Auction Platform</small>
