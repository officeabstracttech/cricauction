          ...
          <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
            ...
            <div class="nav-item">
              <a class="nav-link dropdown-toggle " href="#navbarVerticalMenuDashboards" role="button" data-bs-toggle="collapse" data-bs-target="#navbarVerticalMenuDashboards" aria-expanded="false" aria-controls="navbarVerticalMenuDashboards">
                <span class="nav-link-title">Live Auction</span>
              </a>
            </div>
            <div class="nav-item">
              <a class="nav-link dropdown-toggle " href="#navbarVerticalMenuDashboards" role="button" data-bs-toggle="collapse" data-bs-target="#navbarVerticalMenuDashboards" aria-expanded="false" aria-controls="navbarVerticalMenuDashboards">
                <span class="nav-link-title">Player Management</span>
              </a>
            </div>
            <!-- End Collapse -->
      ...
      <div class="page-header">
        <div class="row align-items-end">
          <div class="col-sm mb-2 mb-sm-0">
            ...
            <h1 class="page-header-title">All Teams</h1>
          </div>
          <!-- End Col -->
      ...
      <div class="row">
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
          ...
          <div class="card h-100">
            <div class="card-body">
              <h6 class="card-subtitle mb-2">Sameer Bakchods</h6>

              <div class="row align-items-center gx-2">
                <div class="col">
                  <span>Remaining Points</span>
                  <span class="text-body fs-5 ms-1">00</span>
                </div>
                <div class="col">
