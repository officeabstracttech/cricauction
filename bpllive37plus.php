...
{
  $currentcounter=mysqli_query($con,"select current_player_count from auction_traker where tournment_id=".$_SESSION["login_user"]." and process=3");
  $currentcounter=mysqli_fetch_row($currentcounter);
  $currentcounter=$currentcounter[0]-1;
  if($currentcounter!=0)
  {

    mysqli_query($con,"update auction_traker set current_player_count=".$currentcounter." where tournment_id=".$_SESSION["login_user"]." and process=3");
  }
...
$result=mysqli_query($con,"select * from auction_traker where tournment_id=".$_SESSION["login_user"]." and process=3");
$counter=0;
$final=0;
 ...
 else
{
  ...
  mysqli_query($con,"insert into auction_traker(tournment_id,total_player,current_player_count,process) values(".$_SESSION["login_user"].",".$count[0].",1,3)");
  $counter=1; 
  if($count[0]==1)
  {
    $final=1;
  ...
  <header id="header" class="navbar navbar-expand-lg navbar-fixed navbar-height navbar-container navbar-bordered bg-white">
    <div class="navbar-nav-wrap">
      ...
      <div class="navbar-nav-wrap-content-start">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a class="btn btn-primary" href="bpllive37plus.php?back=1">Back</a>
          </li>
        <li class="nav-item d-none d-sm-inline-block">
          <a class="btn btn-outline-warning" href="bpllive37plus.php?edit=1&id=<?php echo $mappingdata[0];?>">Edit</a>
        ...
        else
        {
          ...
          echo '<li class="nav-item">
          <a class="btn btn-primary" href="bpllive37plus.php?next=1">Next Player</a>
             </li>';
        }
        ?>
    ...
    <div class="content container-fluid">
     ...
     if($soldflag==0)
     {
        ...
        <div class="card ">
          ...
          <form action="bpllive37plus.php" method="post" onsubmit="this.querySelectorAll(\'input\').forEach(i => i.disabled = false)">
            <div class="mb-3 ">
